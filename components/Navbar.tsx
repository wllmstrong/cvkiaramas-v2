    ...
    <nav className={`fixed w-full z-50 transition-all duration-300 ${
      ...
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex gap-10 text-[11px] font-black uppercase tracking-[0.2em]">
          <a href="#services" className={`hover:text-blue-600 transition-colors ${scrolled ? 'text-slate-600' : 'text-white/80 hover:text-white'}`}>Layanan</a>
          <a href="#legality" className={`hover:text-blue-600 transition-colors ${scrolled ? 'text-slate-600' : 'text-white/80 hover:text-white'}`}>Legalitas</a>
          <a href="#contact" className={`hover:text-blue-600 transition-colors ${scrolled ? 'text-slate-600' : 'text-white/80 hover:text-white'}`}>Kontak</a>
        </div>
